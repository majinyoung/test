			...
			<td style="width: 160px; margin-right: 40px;">
				...
				<div>
					...
					<ul>
						...
						<li onclick="location.href='<%=cp%>/selling'">판매 내역</li>
				...
				<div>
					...
					<ul>
						...
						<li onclick="location.href='<%=cp%>/payment'" style="color: black; font-weight: bolder; ">결제 정보</li>
						<li onclick="location.href='<%=cp%>/account'">판매 정산 계좌</li>
					</ul>
				</div>
			</td>
			<td style="width: 1000px;" align="center">
				<div style="width: 974px; height: 148px; border: 1; border-radius: 5%; padding: 23 0 23 24;">
					프로필 사진
				</div>
				<div></div>
				<div></div>
